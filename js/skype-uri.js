...
var Skype = new function () {
		...
		function l(L) {
			...
			z.setAttribute("style", ("border:0; margin:0; vertical-align:-7px;"));
			...
			if (this.name === this.dropdownLinks.name) {
				...
				r.setAttribute("style", "display: none; position: absolute; margin-top: " + O + "px; margin-left: " + J + "px; width: 100px; padding-left: 20px; padding-right: 20px; border: 2px solid #00AFF0; background-color: white; color: #00AFF0; line-height: 50px; list-style: none; list-style-type: none;");
